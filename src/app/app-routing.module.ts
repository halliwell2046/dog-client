...
const routes: Routes = [
  ...
  { path: "newrequest", component: WalkerNewRequestsComponent, canActivate: [AuthGuard] },
  { path: "walkerrecent", component: WalkerRecentRequestComponent, canActivate: [AuthGuard] },
  { path: "walkerdash", component: WalkerDashboardComponent, canActivate: [AuthGuard] },
  { path: "ownerdash", component: OwnerDashboardComponent, canActivate: [AuthGuard] },
  { path: "availwalker", component: AvailableWalkersComponent, canActivate: [AuthGuard]},
  { path: '**', redirectTo:'' }
